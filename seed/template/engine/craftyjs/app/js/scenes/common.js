...
breakout.logo = () => {
    Crafty.sprite(1, 'assets/logo.png', {
        logo: [0, 0, 131, 175]
    })
...
breakout._createBackgroundViaImage = () => {
    const width = Crafty.stage.elem.clientWidth
    const height = Crafty.stage.elem.clientHeight

    Crafty.sprite(1, 'assets/bg_prerendered.png', {
        bg: [0, 0, width, height]
    })
...
breakout._createBackgroundViaTiles = () => {
