Entropy.State({
    ...
    enter(game, done) {
        ...
        game
        .loader
        .loadFile('./assets/lib/pixi.min.js')
        .loadFile('./assets/lib/howler.min.js')
        .loadFile('./assets/lib/p2.min.js')
        //states
    ...
    exit(game, done) {
        fadeOutScreen('.loading-screen', () => done())
    }
})