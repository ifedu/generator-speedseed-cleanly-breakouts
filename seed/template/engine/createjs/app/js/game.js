...
const Game = {
    ...
    loadAssets() {
        ...
        function getAudioFiles() {
            const filesNames = ['brickDeath', 'countdownBlip']
    ...
    splashScreen() {
        const splashScreen = new SplashScreen(Game.loader.getResult("background"), Game.loader.getResult("logo"), Game)
    },
    ...
    inicia(event) {
        ...
        const elem = Game.stage.getNumChildren()
        ...
        const gameDim = Game.stage.getBounds()
            //scoring Text
    ...
    runCountDown() {
        ...
        const countdown = new createjs.Sprite(Game.spriteSheets.countdown, "go")
        ...
        const dim = Game.stage.getBounds()
    ...
    gameover(isLast) {
        ...
        Game.currentLevel = null
            //scoring Text
        const gameOver = new GameOverScreen(Game.loader.getResult("background"), Game.loader.getResult("logo"), Game, isLast)
    },
    /**
     ...
     */
    buildSpriteSheets() {
        const tileImage = Game.loader.getResult("tiles")
